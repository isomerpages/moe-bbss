...
#### Admissions Exercises/ Pathways **AFTER** National Examinations

**For O Levels**

| Name (Link) of Resources |      Brief Description        |
|:--------------------:|:--------------:|
|    JAE<br>JAE Booklet    | Joint Admissions Exercise (JAE)<br><br>The Joint Admissions Exercise (JAE) is conducted annually by the Ministry of Education (MOE) to allow Singapore-Cambridge GCE ‘O’ Level certificate holders to apply for admission to courses offered by Junior Colleges (JC), Millennia Institute (MI), Polytechnics (Poly) and Institute of Technical Education (ITE).<br><br>Refer to the booklet for post-secondary options, entry requirements, aggregate scores, etc.<br>  |
|  JIE O<br>JIE O Booklet  |                                                                                             Joint Intake Exercise, for O Levels applicants (JIE O)<br><br>The Joint Intake Exercise ‘O’ (JIE ‘O’) is conducted to enable GCE ‘O’ Level holders to apply for the 2-Year National ITE Certificate (Nitec) courses conducted by the Institute of Technical Education (ITE).                                                                                            |

**For N Levels**

| Name (Link) of Resources |       Brief Description         |
|:------------------------:|:----------------:|
|    JIE<br>JIE Booklet    | Joint Intake Exercise (JIE), for N Levels applicants<br><br>There are various JIE:<br><br>·        JIE ‘N’<br><br>Application for 2-Year Nitec Courses (NA and NT)<br> <br>·        JIE ‘E’<br><br>3-Year Nitec Courses with Enhanced Nitec Foundation Programme (NT)<br><br>This programme is conducted to help GCE ‘N’ (Technical) students with 0 or 1 GCE ‘N’ (Technical) Level pass build the necessary literacy and numeracy foundations that will enable them to successfully complete their Nitec course.<br> <br>·        JIE ‘H’<br><br>Application for Higher Nitec Courses under [Direct Entry Scheme to Polytechnic Programme (DPP)](https://www.ite.edu.sg/admissions/full-time-courses/higher-nitec/direct-entry-scheme-to-polytechnic-programme) (Eligible NA)<br> <br>Note: this booklet does not include information relating to [Polytechnic Foundation Programme (PFP)](https://pfp.polytechnic.edu.sg/)<br>  |
|            [PFP](https://pfp.polytechnic.edu.sg/)          |                                                                                                                                                                     Polytechnic Foundation Programme (PFP) (Eligible NA)<br><br>PFP is a one-year programme that offers a practice-oriented curriculum taught by polytechnic lecturers, to better prepare polytechnic-bound N(A) students for entry into the relevant Polytechinc Diploma courses.<br> <br>1 year of Polytechnic Foundation + 3 Years of Diploma Course (upon passing the Foundation Year) in a local polytechnic<br>                                                                                                                                                                     |
|            [DPP](https://www.ite.edu.sg/admissions/full-time-courses/higher-nitec/direct-entry-scheme-to-polytechnic-programme)           |                                                                                                                        Direct Entry Scheme to Polytechnic Programme (DPP) (Eligible NA)<br><br>DPP is for students who would like to benefit from a more hands-on preparation at ITE, to first enrol in a Higher Nitec course at ITE. These students will subsequently be assured of a place in a related Polytechnic Diploma course meeting the requirements in the Higher Nitec course.<br><br>10 weeks Preparatory course + 2 years of Higher Nitec (ITE) + 2 to 3 years of mapped Diploma Course (meeting entry criteria)<br>                                                                                                                        |

## Other ECG Links

|     Name (Link) of Resources      |    Brief Description    |
|:--------:|:------------:|
| [ITE Traineeship (Nitec)](https://www.ite.edu.sg/admissions/traineeship/nitec)<br> <br>[ITE Traineeship (Higher Nitec)](https://www.ite.edu.sg/admissions/traineeship/higher-nitec)<br>  |                  Traineeship is an earn-as-you-learn training scheme for school-leavers who have completed GCE 'O' or 'N' level. You will learn a skill and earn a monthly salary at the same time.<br>                   |
|                      [JPAE](https://jpae.polytechnic.edu.sg/)           | Joint Polytechnic Admission Exercise (JPAE)<br><br>This exercise allows applicants to submit application for admission to full-time courses offered by the five polytechnics.<br><br>For eligible Nitec or Higher Nitec students. |